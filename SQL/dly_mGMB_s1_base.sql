DROP TABLE p_csi_tbs_t.fl_dly_mGMBforecast_s1;

CREATE MULTISET TABLE p_csi_tbs_t.fl_dly_mGMBforecast_s1
AS
(SELECT     			
 ...
 (
   ...
   WHERE 
   created_dt between '2010-01-01' and current_date-2
   AND ck_wacko_yn = 'n'
   AND auct_end_dt >= '2010-01-01'
...
) WITH DATA PRIMARY INDEX (created_dt);