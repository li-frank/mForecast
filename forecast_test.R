...
au <- ts(mobile.cntryPlat[mobile.cntryPlat$country=='AU',]$gmb,frequency=364,start=c(year,dayofYear))
de <- ts(mobile.cntryPlat[mobile.cntryPlat$country=='DE',]$gmb,frequency=364,start=c(year,dayofYear))
uk <- ts(mobile.cntryPlat[mobile.cntryPlat$country=='UK',]$gmb,frequency=364,start=c(year,dayofYear))
us <- ts(mobile.cntryPlat[mobile.cntryPlat$country=='US',]$gmb,frequency=364,start=c(year,dayofYear))
ca <- ts(mobile.cntryPlat[mobile.cntryPlat$country=='CA',]$gmb,frequency=364,start=c(year,dayofYear))
otherCntry <- ts(mobile.cntryPlat[mobile.cntryPlat$country=='Other',]$gmb,frequency=364,start=c(year,dayofYear))

iphone <- ts(mobile.cntryPlat[mobile.cntryPlat$platform=='iPhone App',]$gmb,frequency=364,start=c(year,dayofYear))
ipad <- ts(mobile.cntryPlat[mobile.cntryPlat$platform=='iPad App',]$gmb,frequency=364,start=c(year,dayofYear))
android <- ts(mobile.cntryPlat[mobile.cntryPlat$platform=='AndroidApp',]$gmb,frequency=364,start=c(year,dayofYear))
mweb <- ts(mobile.cntryPlat[mobile.cntryPlat$platform=='Mobile Web',]$gmb,frequency=364,start=c(year,dayofYear))
fsom <- ts(mobile.cntryPlat[mobile.cntryPlat$platform=='FSoM',]$gmb,frequency=364,start=c(year,dayofYear))
otherMob <- ts(mobile.cntryPlat[mobile.cntryPlat$platform=='Other Mobile',]$gmb,frequency=364,start=c(year,dayofYear))
